                    ...
                    <div className="mx-5 max-w-7xl xl:mx-auto">
                        ...
                        <div className="mt-4 flex justify-center">
                            <a
                                ...
                                rel="prev"
                                className="relative inline-flex items-center rounded-l-md border border-gray-50 bg-gray-50 px-2 py-2 text-sm font-medium leading-5 text-red-500 ring-black transition duration-150 ease-in-out focus:z-10 focus:border-black focus:outline-none focus:ring active:bg-gray-700 active:text-gray-500 lg:hover:scale-125"
                            ...
                            <a
                                ...
                                rel="next"
                                className="relative -ml-px inline-flex items-center rounded-r-md border border-gray-50 bg-gray-50 px-2 py-2 text-sm font-medium leading-5 text-blue-500 ring-black transition duration-150 ease-in-out focus:z-10 focus:border-black focus:outline-none focus:ring active:bg-gray-700 active:text-gray-500 lg:hover:scale-125"
